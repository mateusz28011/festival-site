  ...
  return (
    <>
      <div className='flex flex-col sm:flex-row items-center mx-0.5 my-5'>
        <div className='w-11/12 sm:w-1/2 h-5/6 text-lg shadow-lg rounded-xl backdrop-filter backdrop-blur-md bg-lightBlue-200 bg-opacity-50  text-center sm:text-left p-6 sm:px-8 lg:px-16 sm:-ml-4 lg:-ml-7 xl:-ml-10'>
          <h1 className='text-4xl text-white font-medium pb-6 text-center'>
            About us
          </h1>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempore,
            voluptatum. Minus necessitatibus ipsa, assumenda, adipisci quasi
            rerum perferendis repellendus commodi, recusandae voluptatibus
            sapiente. Dolore asperiores fuga, quaerat esse reprehenderit sunt
            reiciendis consequuntur perferendis nam aliquid magnam quibusdam
            molestiae illum repellendus corrupti explicabo eligendi debitis
            eaque neque unde nemo possimus. Ducimus!
          </p>
          <p className='mt-2'>
            ...
            libero magni numquam. Laborum omnis deleniti saepe laboriosam
            facilis magni quas culpa cumque qui.
          </p>
        </div>

        <div className='relative w-11/12 sm:w-4/12 mx-auto'>
          <div className='w-full text-lg shadow-lg rounded-xl backdrop-filter backdrop-blur-md bg-lightBlue-200 bg-opacity-50 text-center sm:text-left my-4 p-6 sm:px-8 lg:px-16'>
            <h1 className='text-4xl text-white font-medium pb-6 text-center'>
              Our goal
            </h1>
            <p className=''>
