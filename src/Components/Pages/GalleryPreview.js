...
const GalleryPreview = ({ images, imageIndex, setShowGalleryPreview }) => {
  ...
  return (
    <div className='fixed h-19/20 w-19/20 max-w-screen-2xl inset-0 z-40 m-auto text-white shadow-lg rounded-xl bg-fuchsia-200 backdrop-filter backdrop-blur-xl bg-opacity-50'>
      <FaTimes
      ...
      <img
        ...
        alt=''
      />
      <div className='absolute right-0 bottom-0 mr-4 mb-4 font-medium text-xl sm:text-3xl'>{`${
        index + 1
